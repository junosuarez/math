...
\begin{flalign*} & \text{Conjecture: }
  \lim\limits_{x \rightarrow 9} \frac{x-9}{\sqrt{x}-3} = 6
& \end{flalign*}

\subsubsection{}
\begin{flalign*} & \text{Conjecture: }
  \lim\limits_{x \rightarrow 4} x^2 = 16
& \end{flalign*}

\subsubsection{}
\begin{flalign*} & \text{Conjecture: }
  \lim\limits_{x \rightarrow 0} sin\left(\frac{1}{x}\right) = DNE
& \end{flalign*}

\subsubsection{}
\begin{flalign*} & \text{Conjecture: }
  \lim\limits_{x \rightarrow 0} \frac{x}{|x|} = DNE
& \end{flalign*}

\subsubsection{}
\begin{flalign*} & \text{Conjecture: }
  \lim\limits_{x \rightarrow -3} 2 = 2
& \end{flalign*}

\subsubsection{}
\begin{flalign*} & \text{Conjecture: }
  \lim\limits_{x \rightarrow 2} \frac{1}{x-2} = DNE
& \end{flalign*}
